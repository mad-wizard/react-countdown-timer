...
var ReactClock = function (_Component) {
  ...
  function ReactClock() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactClock.__proto__ || Object.getPrototypeOf(ReactClock)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      timeRemaining: (0, _moment2.default)(_this.props.endDate).diff(Date.now())
    }, _this.tick = function () {
      _this.setState({
        timeRemaining: (0, _moment2.default)(_this.props.endDate).diff(Date.now())
      });
  ...
  _createClass(ReactClock, [{
    ...
    value: function render() {
      ...
      var duration = _moment2.default.duration(this.state.timeRemaining);
      ...
      return _react2.default.createElement(
        ...
        isDayEnabled && _react2.default.createElement(
          "div",
          { style: Object.assign({}, defaultStyles.clockHeaderStyle) },
          _react2.default.createElement(
            "div",
            { style: Object.assign({}, defaultStyles.clockSubHeader) },
            "DAYS"
          ),
          _react2.default.createElement(
            "div",
        ...
        isDayEnabled && _react2.default.createElement(ReactClock.Seperator, { clockSeparator: clockSeparator }),
        _react2.default.createElement(
          "div",
          { style: Object.assign({}, defaultStyles.clockHeaderStyle) },
          _react2.default.createElement(
        ...
        _react2.default.createElement(ReactClock.Seperator, { clockSeparator: clockSeparator }),
        _react2.default.createElement(
          "div",
          { style: Object.assign({}, defaultStyles.clockHeaderStyle) },
          _react2.default.createElement(
...
ReactClock.Seperator = function (_ref2) {
  var clockSeparator = _ref2.clockSeparator,
      _ref2$shouldShow = _ref2.shouldShow,
      shouldShow = _ref2$shouldShow === undefined ? true : _ref2$shouldShow;
...
if (process.env.NODE_ENV !== 'production') {
  ...
  module.exports = __webpack_require__(147)(ReactIs.isElement, throwOnDirectAccess);
} else {
